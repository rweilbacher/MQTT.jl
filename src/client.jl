...
function write_loop(client)
  try
    ...
    if isa(e, InvalidStateException)
      println("write loop stopped '", e.msg, "'")
    else
      rethrow()
    end
  end
